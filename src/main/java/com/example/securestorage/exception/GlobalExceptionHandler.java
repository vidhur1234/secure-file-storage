...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiResponse<Void>> handleCustomAccessDenied(AccessDeniedCustomException ex) {
    ...
    @ExceptionHandler(IntegrityVerificationException.class)
    public ResponseEntity<ApiResponse<Void>> handleIntegrityException(IntegrityVerificationException ex) {
